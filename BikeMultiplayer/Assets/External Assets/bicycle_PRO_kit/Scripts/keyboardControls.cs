...
public class keyboardControls : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.Y))
            outsideControls.player_2.restartBike = true;
        else
            outsideControls.player_2.restartBike = false;

        if (Input.GetKey(KeyCode.O))
            outsideControls.player_3.restartBike = true;
        else
            outsideControls.player_3.restartBike = false;
