...
public class RPS_Lap : MonoBehaviour {
	...
	public int startLapNumber = 1; //Lap the object starts on. e.g.It might start before or after the start/finish line, where it should be 0 or 1 respectivley
	public bool hasEnd = true; //Is there a final lap
	public int lastLap = 3; //Lap number for the final lap
	public bool freezeShownPosAtEnd = true; //Should the calculated race position freeze as crosses finish line or continue calculating the race position after the race has ended
